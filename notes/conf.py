...
master_doc = 'index'
project = u'Kotaro_RTD_ver1.0-notes'
copyright = u'2016'
version = 'latest'
release = 'latest'
exclude_patterns = ['_build']
pygments_style = 'sphinx'
htmlhelp_basename = 'Kotaro-notes'
html_theme = 'sphinx_rtd_theme'
file_insertion_enabled = False
latex_documents = [
  ('index', 'Kotaro-notes.tex', u'Kotaro-notes Documentation',
   u'', 'manual'),
]
...
context = {
    ...
    'downloads': [
    ("htmlzip", "//readthedocs.org/projects/Kotaro-notes/downloads/htmlzip/latest/"),
    ],
    'subprojects': [
    ],
    'slug': 'Kotaro-notes',
    ...
    'canonical_url': 'http://Kotaro-notes.readthedocs.io/zh_TW/latest/',
    'analytics_code': '',
